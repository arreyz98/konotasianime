import UpdatePostVideoForm from "@/components/admin/UpdatePostVideoForm";
import { getPostVideoById } from "@/lib/data";
...
const Page = async ({params} : {params : Promise<{id : string}>}) => {
    ...
    const dataUpdatePostVideo = await getPostVideoById(id);

    if(!dataUpdatePostVideo){
        notFound()
    }
    return (
        <div>
        ...
        <section className="w-full">
               <UpdatePostVideoForm dataUpdatePostVideo={dataUpdatePostVideo}/>
        </section>
